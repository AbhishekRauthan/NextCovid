...
const AboutContainer: FC<Props> = ({ title, children }) => {
  return (
    <div className="max-w-screen-md flex flex-col justify-center bg-gray-50 space-y-4 py-5 sm:my-10 sm:mx-10 md:mx-auto transform transition-all animate-load">
